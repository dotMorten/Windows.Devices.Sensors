...
namespace Windows.Devices.Sensors.ObjectModel
{
    ...
    /// </summary>
    internal enum SensorAvailabilityChange
    {
        /// <summary>
    ...
    /// </summary>
    internal class SensorsChangedEventArgs : EventArgs
    {
        /// <summary>
        /// The type of change. 
        /// </summary>
	...
	internal delegate void SensorsChangedEventHandler(SensorsChangedEventArgs e);
	...
	internal static class SensorManager
    {
        ...
        private static void BuildSensorTypeMap()
        {
			...
			var asm = typeof(SensorManager).Assembly;
            //foreach (Assembly asm in loadedAssemblies)
            {
                try
                {
                    ...
                    {
                        if (t.IsSubclassOf(typeof(Sensor)) && !t.IsAbstract && !t.IsGenericType)
                        {
