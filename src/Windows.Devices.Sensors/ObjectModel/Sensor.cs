...
using System.Linq;
using Windows.Devices.Sensors.Interop;
using Windows.Devices.Sensors.Metadata;
using Windows.Devices.Sensors.PropertySystem;

namespace Windows.Devices.Sensors.ObjectModel
{
    /// <summary>
    ...
    /// <param name="e"></param>
    internal delegate void DataReportChangedEventHandler(Sensor sender, EventArgs e);
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
	internal delegate void StateChangedEventHandler(Sensor sender, EventArgs e);

    /// <summary>
    /// Defines a general wrapper for a sensor.
    /// </summary>
	internal class Sensor : ISensorEvents
    {
        /// <summary>
    ...
    /// </summary>
	internal struct DataFieldInfo : IEquatable<DataFieldInfo>
    {
